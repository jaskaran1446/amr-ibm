...
save_to = '/home/amukherjee/amr-ibm/AMR_AS_GRAPH_PREDICTION/model/'    #the folder amr model will be saved to  (model name is parameterized by some hyper parameter)
train_from = 'model/gpus_0valid_best.pt'  #default model loading
embed_path = "/home/amukherjee/amr-ibm/AMR_AS_GRAPH_PREDICTION/Data/glove/glove.840B.300d.txt"    #file containing glove embedding
core_nlp_url = 'http://205.172.168.141:9000'     #local host url of standford corenlp server
allFolderPath = os.path.expanduser('~')+"/amr-ibm/AMR_AS_GRAPH_PREDICTION/Data/amr_annotation_r2/data/alignments/split"
resource_folder_path  = os.path.expanduser('~')+"/amr-ibm/AMR_AS_GRAPH_PREDICTION/Data/amr_annotation_r2/"
